...
print('Two-step task:')
for i in range(5):
    print(df_centaur_tst[i].flatten().shape)
...
fig.text(0.012, 0.9, 'a', fontsize=8, weight='bold')
fig.text(0.335, 0.9, 'b', fontsize=8, weight='bold')
fig.text(0.675, 0.9, 'c', fontsize=8, weight='bold')

...
df = pd.read_csv("../../3_data/kool2016when/exp2.csv")
...
kool_eval_dataset = dataset['eval'].filter(lambda example: example['experiment'].startswith('kool2016when/exp2.csv'))
...
instructions = (
    ...
    "Your goal is to get as much treasure as possible over the next {n_trials} days.\n\n"
)
